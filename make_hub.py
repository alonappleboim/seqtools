...
class HubBuider(object):
    ...
    def track(self):
        ...
        if self.www_dir is not None: self. add_hub()
...
def build_parser():
    ...
    g.add_argument('--bw_path', '-fp', type=str, default=None,
                   help='path to a directory containing bigwig files')
    g.add_argument('--sample_db', '-sd', default=None,
                   help='iven the pipeline will try to continue a previous run, specified through '
